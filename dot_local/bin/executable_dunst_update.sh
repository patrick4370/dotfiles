...
if [ ${pac_num} -gt 0 ] || [ ${aur_num} -gt 0 ]; then
    ...
    ACTION=$(dunstify -r 1234 --urgency=critical --icon=~/.local/share/icons/dunst/arch_icon.png \
           --action="Update,update_action" "System Updates" "\(Pacman\): $pac_num   \(AUR\): $aur_num")
